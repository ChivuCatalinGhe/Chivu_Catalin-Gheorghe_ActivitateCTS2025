...
import BrutarieStaticBlock.BrutarieStaticBlock;
...
public class Program {
    public static void main(String[] args) {
        ...
        BrutarieStaticBlock brutaria5 = BrutarieStaticBlock.getInstanta("Brutaria5","Alta adresa",1234567);
        ...
        System.out.println(brutaria5.getDenumire() + " / " + brutaria5.getAdresa());
    }
}
